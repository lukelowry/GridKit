  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome constructionAndValidation()
      {
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> missing_hygov_trate_model(
            missing_hygov_trate);
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> bad_hygov_hdam_model(
            bad_hygov_hdam);
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> bad_hygov_rtemp_model(
            bad_hygov_rtemp);
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> bad_hygov_limits_model(
            bad_hygov_limits);
        ...
        PhasorDynamics::Governor::Hygov<ScalarT, IdxT> bad_hygov_gate_limits_model(
            bad_hygov_gate_limits);
