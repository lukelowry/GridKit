  ...
  namespace Testing
  {
    ...
    public:
      ...
      TestOutcome initializesFromPowerFlowAndPublishesSignals()
      {
        ...
        success *= scalarMatches(regca.y()[index(Vars::IR)], ir_signal, "IR");
        success *= scalarMatches(regca.y()[index(Vars::II)], ii_signal, "II");
      ...
      TestOutcome baseSignals()
      {
        ...
        success *= scalarMatches(regca.y()[index(Vars::IP)], static_cast<ScalarT>(0.8), "IP");
        success *= scalarMatches(regca.y()[index(Vars::IQ)], static_cast<ScalarT>(-0.2), "IQ");
        success *= scalarMatches(regca.y()[index(Vars::IR)], static_cast<ScalarT>(0.4), "IR");
        success *= scalarMatches(regca.y()[index(Vars::II)], static_cast<ScalarT>(0.1), "II");
        success *= scalarMatches(regca.y()[index(Vars::PBR)], p0, "PBR");
        success *= scalarMatches(regca.y()[index(Vars::QBR)], q0, "QBR");
      ...
      TestOutcome externalCommandsDriveRuntimeResidual()
      {
        ...
        const ScalarT expected_ip_residual =
            regca.y()[index(Vars::LP)]
            + Math::ramp(ip_error - tg * regca.y()[index(Vars::LP)]) / tg
            - Math::ramp(ip_error - tg * regca.y()[index(Vars::UP)]) / tg;
      ...
      TestOutcome busInjectionUsesSystemBase()
      {
        ...
        success *= isEqual(bus.Ir(), regca.y()[index(Vars::IR)], kTol);
        success *= isEqual(bus.Ii(), regca.y()[index(Vars::II)], kTol);
