...
namespace GridKit
{
  namespace PhasorDynamics
  {
    namespace Converter
    {
      ...
      int Regca<scalar_type, index_type>::evaluateJacobianBlocks()
      {
        using ModelT       = GridKit::PhasorDynamics::Converter::Regca<ScalarT, IdxT>;
        ...
        GridKit::Enzyme::Sparse::DhDy<ModelT,
