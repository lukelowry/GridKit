...
namespace GridKit
{
  namespace PhasorDynamics
  {
    namespace Source
    {
      ...
      /**
       * @brief Constructs a CSV-backed signal source without parameters
       */
      ...
      /**
       * @brief Constructs a CSV-backed signal source from a signal and data
       */
      template <class ScalarT, typename IdxT>
      ...
      /**
       * @brief Constructs a CSV-backed signal source from data
       */
      template <class ScalarT, typename IdxT>
      ...
      /**
       * @brief Verify CSV data and signal configuration
       */
      template <class ScalarT, typename IdxT>
      ...
      /**
       * @brief Initialization of the CSV-backed signal source
       */
      template <class ScalarT, typename IdxT>
      ...
      /**
       * @brief Interpolate the signal value at a time
       */
      template <class ScalarT, typename IdxT>
      typename CsvSignalSource<ScalarT, IdxT>::RealT CsvSignalSource<ScalarT, IdxT>::interpolate(RealT t) const
      {
        ...
        RealT alpha = (t - time_samples_[i]) / (time_samples_[i + 1] - time_samples_[i]);
        return (1.0 - alpha) * value_samples_[i] + alpha * value_samples_[i + 1];
      }
       ...
       */
      template <class ScalarT, typename IdxT>
      std::string CsvSignalSource<ScalarT, IdxT>::trim(const std::string& value)
      {
      ...
      /**
       * @brief Split a simple comma-separated line
       */
      template <class ScalarT, typename IdxT>
      std::vector<std::string> CsvSignalSource<ScalarT, IdxT>::splitCsvLine(const std::string& line)
      {
