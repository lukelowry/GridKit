...
are specified:
  ...
  `Repca`              | the REPCA renewable plant-control model              | `bus`, `ibranchr`, `ibranchi`, `pbranch`, `qbranch`, `freq`, `freqref`\*, `vref`\*, `qref`\*, `pplantref`\*, `qext`, `pext` | `mva`, `VcompFlag`, `RefFlag`, `Freqflag`, `Tfltr`, `Vfrz`, `Rc`, `Xc`, `Kc`, `dbdlow`, `dbdupper`, `emax`, `emin`, `Kp`, `Ki`, `Qmax`, `Qmin`, `Tft`, `Tfv`, `Tp`, `fdbd1`, `fdbd2`, `Ddn`, `Dup`, `femax`, `femin`, `Kpg`, `Kig`, `Pmax`, `Pmin`, `Tlag` | `qext`, `pext`, `vmeas`, `qmeas`, `pmeas`
